...
public class PostServiceStubImpl implements PostService {
    private List<Post> posts = new ArrayList<Post>() {{
        add(new Post(1L, "First Post", "<p>Line #1.</p><p>Line #2</p>", null, new Date()));
        add(new Post(2L, "Second Post", "Second post content:<ul><li>line 1</li><li>line 2</li></p>",
                new User(10L, "Johnny", "John Doe"), new Date()));
        add(new Post(3L, "Post #3", "<p>The post number 3 nice</p>",
                new User(10L, "merry", null), new Date()));
        add(new Post(4L, "Forth Post", "<p>Not interesting post</p>", null, new Date()));
        add(new Post(5L, "Post Number 5", "<p>Just posting</p>", null, new Date()));
        add(new Post(6L, "Sixth Post", "<p>Another interesting post</p>", null, new Date()));
    }};
